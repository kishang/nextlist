/* Nextlist v0.1 (c) 2013 Kishan Gupta
...
return t?e?(i=this.data("nextweb.settings"),i.nextwebNodeAddress=t,i.nextwebNodeSecret=e,this.data("nextweb.settings",i),d(this),this.data("nextlist.nextwebMonitor")&&(r(this),l(this)),this):(n("Invalid Nextweb node secret specified"),this):(n("Invalid Nextweb node address specified"),this)},u.reload=function(){return d(this),this},u.getSession=function(){return this.data("nextlist.settings").nextwebSession},u.startMonitor=function(t){return l(this,t),this},u.stopMonitor=function(){return r(this),this},t.fn.nextlist=function(i){var o,r=this.eq(0).filter("ul:data(ui-sortable), ol:data(ui-sortable)")
return r.length?u[i]?r.data("nextlist.settings")?u[i].apply(r,Array.prototype.slice.call(arguments,1)):(n("Cannot invoke method before Nextlist initialization"),this):r.data("nextlist.settings")?(n("Nextlist has already been initialized for this element"),this):(o=t.extend({},x,i),o.nextwebSession||Nextweb&&Nextweb.createSession?o.nextwebSession&&!o.nextwebSession.seed?n("A valid Nextweb session was not sepcified"):t.fn.sortable===e?n("jQuery UI Sortable is not available"):o.nextwebNodeAddress?o.nextwebNodeSecret?(o.nextwebSession||(o.nextwebSession=Nextweb.createSession()),r.data({"nextlist.settings":o,"nextlist.nPendingChanges":0}),d(r,function(){o.autoStartMonitoring&&l(r)}),r.on({sortstart:function(t,e){e.item.data({"nextlist.originalParent":e.item.parents("ul").get(0),"nextlist.originalIndex":e.item.index()})},sortstop:function(t,e){if(e.item.data("nextlist.originalParent")===e.item.parents("ul").get(0)){var n,i=r.data("nextlist.nextwebNode")
...
return d.data("nextlist.settings")?(d.data("nextlist.nextwebNode").remove(i.item.data("nextlist.nextwebNode")),o=a(i.item.find("span.nextlist-item-text").text(),i.item.index(),r.data("nextlist.nextwebNode"),r.data("nextlist.settings").nextwebSession),i.item.addClass("nextlist-item-unsynced"),s(d),s(r,function(){i.item.removeClass("nextlist-item-unsynced").data("nextlist.nextwebNode",o.get())}),void 0):(n("Nextlist has not been initialized for the source list"),void 0)}})):n("A valid Nextweb node secret was not specified"):n("A valid Nextweb node address was not specified"):n("Nextweb object not found"),this):(n("Invalid selection. The first element must be either an <ul> or an <ol> element and must have jQuery UI Sortable initialized"),this)},t.fn.nextlist.debugMode=!1}(jQuery)